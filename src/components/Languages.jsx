    ...
    <nav className="navbar">
      <div className="inner">
        <ul>
          ...
          <li className={activeSection === "summary" ? "active" : ""}><a href="#summary">Summary</a></li>
          ...
          <li className={activeSection === "certifications" ? "active" : ""}><a href="#certifications">Certifications</a></li>
          <li className={activeSection === "awards" ? "active" : ""}><a href="#awards">Awards</a></li>
          <li className={activeSection === "languages" ? "active" : ""}><a href="#languages">Languages</a></li>
